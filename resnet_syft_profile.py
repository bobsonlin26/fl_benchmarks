...
import pdb
# import resnet
# from syft import models
# from syft.models import resnet
import alexnet
import torchvision.models as models
import syft as sy
import time
...
my_resnet18 = models.vgg11()
# my_resnet18.build(torch.zeros([1, 3, 32, 32], dtype=torch.float).to(device))
...
end_time = time.time()
print("[PROF]", "LocalTraining", "duration", end_time - start_time)

...
async def fit_model_on_worker(
    ...
    result_list = await worker.async_fit2_sagg_mc(model_config, dataset_key="cifar10", encrypters=encrypters, return_ids=return_ids)
